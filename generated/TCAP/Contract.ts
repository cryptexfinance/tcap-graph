...
export class Contract__oracleRoundStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  oracleRoundState(
  ...
  ): Contract__oracleRoundStateResult {
    let result = super.call(
      "oracleRoundState",
    ...
    return new Contract__oracleRoundStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_oracleRoundState(
    _oracle: Address,
    _queriedRoundId: BigInt
  ): ethereum.CallResult<Contract__oracleRoundStateResult> {
    let result = super.tryCall(
      "oracleRoundState",
      "oracleRoundState(address,uint32):(bool,uint32,int256,uint64,uint64,uint128,uint8,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__oracleRoundStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
