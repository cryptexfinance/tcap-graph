...
export class ETHVault__getVaultResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class ETHVault__vaultsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class ETHVault extends ethereum.SmartContract {
  ...
  getVault(_id: BigInt): ETHVault__getVaultResult {
    let result = super.call(
      "getVault",
    ...
    return new ETHVault__getVaultResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_getVault(_id: BigInt): ethereum.CallResult<ETHVault__getVaultResult> {
    let result = super.tryCall(
      "getVault",
      "getVault(uint256):(uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_id)]
  ...
  vaults(param0: BigInt): ETHVault__vaultsResult {
    let result = super.call(
      "vaults",
    ...
    return new ETHVault__vaultsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress()
  ...
  try_vaults(param0: BigInt): ethereum.CallResult<ETHVault__vaultsResult> {
    let result = super.tryCall(
      "vaults",
      "vaults(uint256):(uint256,uint256,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
...
export class AddCollateralETHCall extends ethereum.Call {
  get inputs(): AddCollateralETHCall__Inputs {
    return new AddCollateralETHCall__Inputs(this);
  }

  get outputs(): AddCollateralETHCall__Outputs {
    return new AddCollateralETHCall__Outputs(this);
  }
}

export class AddCollateralETHCall__Inputs {
  _call: AddCollateralETHCall;

  constructor(call: AddCollateralETHCall) {
    this._call = call;
  }
}

export class AddCollateralETHCall__Outputs {
  _call: AddCollateralETHCall;
...
export class RemoveCollateralETHCall extends ethereum.Call {
  get inputs(): RemoveCollateralETHCall__Inputs {
    return new RemoveCollateralETHCall__Inputs(this);
  }

  get outputs(): RemoveCollateralETHCall__Outputs {
    return new RemoveCollateralETHCall__Outputs(this);
  }
}

export class RemoveCollateralETHCall__Inputs {
  _call: RemoveCollateralETHCall;

  constructor(call: RemoveCollateralETHCall) {
    this._call = call;
  }
...
export class RemoveCollateralETHCall__Outputs {
  _call: RemoveCollateralETHCall;
