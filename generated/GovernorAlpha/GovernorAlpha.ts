...
export class GovernorAlpha extends ethereum.SmartContract {
  ...
  ctx(): Address {
    let result = super.call("ctx", "ctx():(address)", []);

    return result[0].toAddress();
  }

  try_ctx(): ethereum.CallResult<Address> {
    let result = super.tryCall("ctx", "ctx():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<GovernorAlpha__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
  ...
  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<GovernorAlpha__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<GovernorAlpha__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  receipts(param0: BigInt, param1: Address): GovernorAlpha__receiptsResult {
    let result = super.call(
      "receipts",
      "receipts(uint256,address):(bool,bool,uint96)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
    ...
    return new GovernorAlpha__receiptsResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBigInt()
    );
  ...
  try_receipts(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<GovernorAlpha__receiptsResult> {
    let result = super.tryCall(
      "receipts",
      "receipts(uint256,address):(bool,bool,uint96)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GovernorAlpha__receiptsResult(
        value[0].toBoolean(),
        value[1].toBoolean(),
        value[2].toBigInt()
      )
