...
export class Ctx__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Ctx extends ethereum.SmartContract {
  static bind(address: Address): Ctx {
    return new Ctx("Ctx", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Ctx__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Ctx__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Ctx__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Ctx__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
