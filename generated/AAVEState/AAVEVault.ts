...
export class AAVEVault__getVaultResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class AAVEVault__vaultsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class AAVEVault extends ethereum.SmartContract {
  static bind(address: Address): AAVEVault {
    return new AAVEVault("AAVEVault", address);
  }
  ...
  getVault(_id: BigInt): AAVEVault__getVaultResult {
    let result = super.call(
      "getVault",
    ...
    return new AAVEVault__getVaultResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_getVault(_id: BigInt): ethereum.CallResult<AAVEVault__getVaultResult> {
    let result = super.tryCall(
      "getVault",
      "getVault(uint256):(uint256,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_id)]
  ...
  vaults(param0: BigInt): AAVEVault__vaultsResult {
    let result = super.call(
      "vaults",
    ...
    return new AAVEVault__vaultsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress()
  ...
  try_vaults(param0: BigInt): ethereum.CallResult<AAVEVault__vaultsResult> {
    let result = super.tryCall(
      "vaults",
      "vaults(uint256):(uint256,uint256,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
